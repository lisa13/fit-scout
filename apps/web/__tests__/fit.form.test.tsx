...
vi.mock('../components/ResultCard', () => ({
  ResultCard: ({ sizeLabel, confidence }: { sizeLabel: string; confidence: number }) => (
...
describe('FitPage', () => {
  ...
  it('renders the fit page with form', () => {
    ...
    expect(screen.getByText('Enter your measurements and preferences to get personalized size recommendations')).toBeInTheDocument()
