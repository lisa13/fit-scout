...
vi.mock('../components/QueryPanel', () => ({
  QueryPanel: ({ onSubmit, isLoading }: { onSubmit: (data: any) => void; isLoading: boolean }) => (
...
describe('FindPage', () => {
  ...
  it('renders the find page with initial state', () => {
    ...
    expect(screen.getByText('Upload a product image or paste a URL to find similar items')).toBeInTheDocument()
  ...
  it('shows products grid after successful submission', async () => {
    const mockProducts = [
      { id: '1', title: 'Test Product', brandId: 'nike', category: 'shoes', price: 100, image: 'test.jpg', score: 0.95 },
      { id: '2', title: 'Another Product', brandId: 'adidas', category: 'clothing', price: 80, image: 'test2.jpg', score: 0.87 }
    ]
