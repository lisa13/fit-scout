...
declare module 'react-hook-form' {
  ...
  export function FormProvider(props: { children: ReactNode; [key: string]: any }): JSX.Element
}
...
declare module '@radix-ui/react-dialog' {
  ...
  export const Trigger: ComponentType<{ children: ReactNode; asChild?: boolean; [key: string]: any }>
  export const Content: ComponentType<{ children: ReactNode; [key: string]: any }>
  export const Overlay: ComponentType<{ [key: string]: any }>
  export const Close: ComponentType<{ [key: string]: any }>
  export const Portal: ComponentType<{ children: ReactNode; [key: string]: any }>
  export const Title: ComponentType<{ children: ReactNode; [key: string]: any }>
  export const Description: ComponentType<{ children: ReactNode; [key: string]: any }>
}

declare module '@radix-ui/react-select' {
  import { ComponentType, ReactNode } from 'react'
  export const Root: ComponentType<{ children: ReactNode; [key: string]: any }>
  export const Trigger: ComponentType<{ children: ReactNode; [key: string]: any }>
  export const Value: ComponentType<{ placeholder?: string; [key: string]: any }>
  export const Content: ComponentType<{ children: ReactNode; [key: string]: any }>
  export const Item: ComponentType<{ children: ReactNode; value: string; [key: string]: any }>
  export const Portal: ComponentType<{ children: ReactNode; [key: string]: any }>
}
...
declare module '@radix-ui/react-collapsible' {
  import { ComponentType, ReactNode } from 'react'
  export const Root: ComponentType<{ children: ReactNode; open?: boolean; onOpenChange?: (open: boolean) => void; [key: string]: any }>
  export const Trigger: ComponentType<{ children: ReactNode; asChild?: boolean; [key: string]: any }>
  export const Content: ComponentType<{ children: ReactNode; [key: string]: any }>
}
...
declare module '@radix-ui/react-form' {
  import { ComponentType, ReactNode } from 'react'
  export const Root: ComponentType<{ children: ReactNode; [key: string]: any }>
  export const Field: ComponentType<{ children: ReactNode; [key: string]: any }>
  export const Label: ComponentType<{ children: ReactNode; [key: string]: any }>
  export const Control: ComponentType<{ children: ReactNode; [key: string]: any }>
  export const Message: ComponentType<{ children: ReactNode; [key: string]: any }>
}
